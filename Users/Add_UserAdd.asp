...
If Request.Form("action")="add" then
	  ...
	  Sql1 = "select * from FS_Contribution where 1=0"
	  ...
	  Rs.update
	  Conn.execute("update FS_members set ConNum=ConNum+1 where MemName='"&Replace(Replace(Request.Form("Author"),"""",""),"'","")&"'")
...
Else
	...
	border=0>
								...
								<TBODY>
								  <TR> 
									<TD width="15%" height="26"> 
									  <div align="left"> <font color="#000000"><img src="Images/arr2.gif" width="10" height="10"><img src="Images/arr2.gif" width="10" height="10"><a href="Add_Contribution.asp"><font color="#FF0000">我要投稿</font></a> 
										</font> </div></TD>
							  ...
							  <table width="100%" border="0" align="center" cellpadding="6" cellspacing="1" bgcolor="#CCCCCC">
								<form action="" method="POST" name="NewsForm">
								  <tr bgcolor="#F6F6F6"> 
									...
									<td width="85%"> 
									  <input name="Title" id="Title2" style="width:80% "></td>
								  </tr>
								  <tr bgcolor="#F6F6F6"> 
									<td> 
									  <div align="right">&#21103; 
										&#26631; &#39064; </div></td>
									<td> 
									  <input name="SubTitle" id="SubTitle2" style="width:80% "></td>
								  </tr>
								  <tr bgcolor="#F6F6F6"> 
									<td> 
									  <div align="right">&#20851; 
										&#38190; &#23383;</div></td>
									<td> 
									  <input name="KeyWords" type="text" id="KeyWords2" style="width:42% "> 
									  &nbsp; &nbsp;&nbsp; &#20316;&#32773; <input name="Author" type="hidden" style="width:41% " value="<%=RsUserObj("MemName")%>"> 
									  <input name="Author" type="text" style="width:30% " value="<%=RsUserObj("MemName")%>" disabled> 
									</td>
								  </tr>
								  <tr bgcolor="#F6F6F6"> 
									<td> 
									...
									<td> 
									  <select name="ClassID" id="select" style="width:50% ">
		   <%
		   Dim UserAddRikerObj
		   ...
		   %>
										<option value="<%=UserAddRikerObj("ClassID")%>"><%=UserAddRikerObj("ClassCName")%></option>
		   <%
