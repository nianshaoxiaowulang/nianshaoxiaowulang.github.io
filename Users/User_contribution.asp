...
If request("action")="del" then
	  ...
	  Response.Write("<script>alert(""稿件删除成功！"&CopyRight&""");location=""User_Contribution.asp"";</script>")
	  Response.End
End if
Dim RsUserObj
                            ...
                            <TBODY>
                              <TR> 
                                <TD width="15%" height="26"> 
                                  <div align="left"> <font color="#000000"><img src="Images/arr2.gif" width="10"><img src="Images/arr2.gif" width="10"><a href="Add_Contribution.asp">我要投稿</a> 
                                    </font> </div></TD>
                                <TD width="17%"><img src="Images/arr2.gif" width="10"><img src="Images/arr2.gif" width="10"><a href="User_Contribution.asp"><font color="#FF0000">未审核投稿</font></a></TD>
...
RsCon.Source="select * from FS_Contribution where Author='"& Replace(session("MemName"),"'","") &"' order by AddTime desc"
...
if RsCon.eof then
	   ...
	   Response.Write"<TR><TD>没有记录。</TD></TR>"
		...
		response.Write("<tr><td width=40>[<a href=?action=del&ContID="&Rscon("ContID")&" onclick=""return deltf()"" title=删除>删</a>]&nbsp;[<a href=Modify_Contribution.asp?ContID="&Rscon("ContID")&" title=修改>修</a>]</td><td>·<a href=ReadCon.asp?ContID="&Rscon("ContID")&" target=_blank>"&Left(Rscon("title"),25)&"</a></td><td width=60>[<font color=#666666>"&year(Rscon("AddTime"))&"-"&month(Rscon("AddTime"))&"-"&day(Rscon("AddTime"))&"</font>]<td></tr>")
		RsCon.movenext
		next
		%>
</table>
