...
function InsertScript()
{
	...
	window.returnValue='{%=ClassicalPic("'+ClassListStr+'","'+NewsNumberStr+'","'+SoonClassStr+'","'+ShowTitleStr+'","'+TitleNumberStr+'","'+OpenModeStr+'","'+RowNumStr+'","'+PicWidthStr+'","'+PicHeightStr+'","'+CssFileStr+'","'+RowSpaceStr+'")%}';
	window.close();
}
