...
<div align="center">
  <table width="90%" border="0" cellspacing="0" cellpadding="0">
    <form action="" method="post" name="CNListForm">
      <tr> 
        <td width="42%" height="30"><div align="left">分页数量 
            <input name="NewsNumber" type="text" id="NewsNumber" style="width:70%;" value="10">
          </div></td>
        <td width="50%"><div align="left">排列列数 
            <input name="RowNumber" type="text" id="RowNumber2" style="width:70%;" value="1">
          </div></td>
      </tr>
      <tr> 
        <td height="30"><div align="left">标题字数 
            <input name="TitleNumber" type="text" id="TitleNumber2" style="width:70%;" value="30">
          </div></td>
...
function InsertScript()
{
	...
	window.returnValue='{%=SpecialLastNewsList("'+NewsNumberStr+'","'+RowNumberStr+'","'+NaviPicStr+'","'+BGPicStr+'","'+RowHeightStr+'","'+CssFileStr+'","'+OpenModeStr+'","'+DetachPageStr+'","'+TitleNumberStr+'","'+DateRuleStr+'","'+DateRightStr+'","'+DateCSSStyleStr+'","'+TxtNaviStr+'")%}';
	window.close();
}
