...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr> 
    <td height="30"><div align="left">标题字数 
        <input name="TitleNumber" type="text" id="TitleNumber" style="width:70%;" value="20">
      </div></td>
...
function InsertScript()
{
	...
	window.returnValue='{%=ClassicalNews("'+ClassListStr+'","'+NewsNumberStr+'","'+SoonClassStr+'","'+ShowTitleStr+'","'+TitleNumberStr+'","'+OpenModeStr+'","'+RowNumStr+'","'+PicWidthStr+'","'+PicHeightStr+'","'+CssFileStr+'","'+RowSpaceStr+'")%}';
	window.close();
}
