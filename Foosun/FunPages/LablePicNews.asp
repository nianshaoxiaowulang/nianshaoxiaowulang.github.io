  ...
  <table width="96%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr> 
      ...
      <td height="30"><div align="left">图片高度 
          <input name="PicHeight" type="text" id="PicHeight" style="width:70%;" value="60">
        </div></td>
    </tr>
    <tr> 
      <td height="30"> <div align="left">间　　距 
          <input name="RowSpace" type="text" id="PicWidth3" style="width:70%;" value="6">
        </div></td>
...
function InsertScript()
{
	...
	window.returnValue='{%=PicNews("'+ClassListStr+'","'+NewsNumberStr+'","'+ShowTitleStr+'","'+OpenModeStr+'","'+TitleNumberStr+'","'+RowNumStr+'","'+PicWidthStr+'","'+PicHeightStr+'","'+CssFileStr+'","'+RowSpaceStr+'")%}';
	window.close();
}
