...
<table width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#999999">
  ...
  <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#EBEBEB">
    <tr bgcolor="#FFFFFF"> 
      ...
      <td> 
        <input name="Name" type="text" id="Name" style="width:100%" title="会员组名称,长度不能超过25个中文字符" value="<%=Request("Name")%>" maxlength="25"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="26"> 
        <div align="center">权限级别</div></td>
      <td> 
        <input name="PopLevel" type="text" id="PopLevel" style="width:100%" title="输入会员权限级别,数值越小,权限越大,范围:10-32767,用于设置新闻浏览权限" onBlur="CheckNumber(this,'权限级别');" value="<%=Request("PopLevel")%>" maxlength="9"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="26"> 
        <div align="center">初始积分</div></td>
      <td> 
        <input name="Point" type="text" id="Point" style="width:100%" title="会员的初始积分数,分数越大,权限越高,多用于新闻浏览以外的其它会员动作" value="<%=Request("Point")%>" maxlength="9"></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td> 
        <div align="center">说&nbsp;&nbsp;&nbsp;&nbsp;明</div></td>
      <td> 
        <textarea name="Comment" rows="6" id="Comment" style="width:100%" title="对会员组的说明文字,方便后台管理"><%=Request("Comment")%></textarea></td>
    </tr>
</table>
</form>
</body>
